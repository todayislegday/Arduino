...
//   if((timeinfo->tm_hour==2&&timeinfo->tm_min==15)||)
  for(int i=0;i<3;i++){
     display.clearDisplay();
   drawgettogetherday();
   drawtime();
...
void getwheatherinfo(){//날씨 정보를 획득합니다.
    ...
    if (http.begin(client, "http://apis.data.go.kr/1360000/VilageFcstInfoService/getVilageFcst?serviceKey=7503qUB6FNb%2BuC5jrw1iycVdkNUroYZogV7Nav12eN5SdqjGsXoGzWv1OSJn4D7FTFHDfGgWas%2FQVJbUF9T30g%3D%3D&numOfRows=50&&base_date=20200423&base_time=0200&nx=60&ny=121&dataType=JSON")) {  // HTTP
