...
int nt[5]={0,0,0,0,0}; //기온
int tmn=0; //최저기온
int tmx=0; //최고기온
int sky[5]={0,0,0,0,0}; //하늘상태,강수량 포함.
int wloop=0; 
int wloopi=0; 
const unsigned char *skyimg=NULL;
int timezone = 9;
...
// 'clockfont', 32x15px
const unsigned char clockfont [] PROGMEM = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x40, 0x00, 
  0x11, 0x1f, 0x40, 0x00, 0x11, 0x02, 0x40, 0x00, 0x11, 0x06, 0x70, 0x00, 0x11, 0x0c, 0x40, 0x00, 
  0x39, 0x10, 0x40, 0x00, 0x6d, 0x08, 0x40, 0x00, 0x45, 0x08, 0x00, 0x00, 0x01, 0x08, 0x00, 0x00, 
  0x01, 0x0f, 0xc0, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

// 'tempfont', 32x15px
const unsigned char tempfont [] PROGMEM = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x0f, 0x07, 0xe0, 0x00, 0x10, 0x84, 0x00, 0x00, 0x10, 0x84, 0x00, 0x00, 0x0f, 0x04, 0x00, 0x00, 
  0x3f, 0xc7, 0xe0, 0x00, 0x10, 0x01, 0x80, 0x00, 0x10, 0x01, 0x80, 0x00, 0x1f, 0x8f, 0xf0, 0x00, 
...
void drawnowweather(){
  display.drawBitmap(0,0,skyimg,64,64, WHITE);
  ...
  display.print(tmx);
  display.display();
  Serial.printf("날씨 %d,%d,%d,%d,%d\n",sky[0],sky[1],sky[2],sky[3],sky[4]);
  Serial.printf("기온 %d,%d,%d,%d,%d\n",nt[0],nt[1],nt[2],nt[3],nt[4]);
  delay(5000);
  }  
void draw5weather(){
  ...
  struct tm* timeinfo;
  timeinfo=localtime(&now);
  display.drawBitmap(0,0,tempfont,32,15, WHITE);
  display.drawBitmap(0,50,clockfont,32,15, WHITE);
   if(timeinfo->tm_hour%3==0){
...
void drawtime(){
  ...
  timeinfo=localtime(&now);
   if(timeinfo->tm_hour<13){
    display.drawBitmap(10,50,morningfont,32,15, WHITE);
     display.print(timeinfo->tm_hour);
    }else{
       display.drawBitmap(10,50,afternoonfont,32,15, WHITE);
