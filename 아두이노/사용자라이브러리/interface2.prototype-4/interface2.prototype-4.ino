  ...
  timeinfo=localtime(&now);
   ...
   if(timeinfo->tm_hour<5){
    if(timeinfo->tm_hour<2){
     ...
     getwheatherinfo(timeinfo->tm_year+1900,timeinfo->tm_mon+1,timeinfo->tm_mday-1,23,0);//0~2시사이니까 그전날 23시가 마지막
    }else {
         getwheatherinfo(timeinfo->tm_year+1900,timeinfo->tm_mon+1,timeinfo->tm_mday,2,0);
      if(timeinfo->tm_hour%3==0)
              getwheatherinfo(timeinfo->tm_year+1900,timeinfo->tm_mon+1,timeinfo->tm_mday,timeinfo->tm_hour-1,0);
       if(timeinfo->tm_hour%3==1)
               getwheatherinfo(timeinfo->tm_year+1900,timeinfo->tm_mon+1,timeinfo->tm_mday,timeinfo->tm_hour-2,0);
       if(timeinfo->tm_hour%3==2)
               getwheatherinfo(timeinfo->tm_year+1900,timeinfo->tm_mon+1,timeinfo->tm_mday,timeinfo->tm_hour,0);
      }
}
void loop() {
//  getwheatherinfo();
  ...
  display.clearDisplay();
   ...
   if(((timeinfo->tm_hour==2&&timeinfo->tm_min==0)||(timeinfo->tm_hour==5&&timeinfo->tm_min==0)||(timeinfo->tm_hour==8&&timeinfo->tm_min==0)||(timeinfo->tm_hour==11&&timeinfo->tm_min==0)||(timeinfo->tm_hour==14&&timeinfo->tm_min==0)||(timeinfo->tm_hour==17&&timeinfo->tm_min==0)||(timeinfo->tm_hour==20&&timeinfo->tm_min==0)||(timeinfo->tm_hour==23&&timeinfo->tm_min==0))&&wloop==0){
         getwheatherinfo(timeinfo->tm_year+1900,timeinfo->tm_mon+1,timeinfo->tm_mday,timeinfo->tm_hour,1);  //한번 갱신하고 다시 실행 안되도록...
