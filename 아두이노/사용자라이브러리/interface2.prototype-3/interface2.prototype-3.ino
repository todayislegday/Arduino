...
//  getwheatherinfo();
  ...
  display.clearDisplay();
   ...
   if(((timeinfo->tm_hour==2&&timeinfo->tm_min==20)||(timeinfo->tm_hour==5&&timeinfo->tm_min==20)||(timeinfo->tm_hour==8&&timeinfo->tm_min==20)||(timeinfo->tm_hour==11&&timeinfo->tm_min==20)||(timeinfo->tm_hour==14&&timeinfo->tm_min==20)||(timeinfo->tm_hour==17&&timeinfo->tm_min==20)||(timeinfo->tm_hour==20&&timeinfo->tm_min==20)||(timeinfo->tm_hour==23&&timeinfo->tm_min==20))&&wloop==0){
         getwheatherinfo(timeinfo->tm_year+1900,timeinfo->tm_hour,1);  //한번 갱신하고 다시 실행 안되도록...
         wloop=1;
   }
   for(int i=0;i<5;i++){
   drawgettogetherday();
...
void getwheatherinfo(int year,int hour,int ini){//날씨 정보를 획득합니다.
    WiFiClient client;
    ...
    char s_year[500];
    sprintf(s_year,"http://apis.data.go.kr/1360000/VilageFcstInfoService/getVilageFcst?serviceKey=7503qUB6FNb%%2BuC5jrw1iycVdkNUroYZogV7Nav12eN5SdqjGsXoGzWv1OSJn4D7FTFHDfGgWas%%2FQVJbUF9T30g%%3D%%3D&numOfRows=50&base_date=20200427&base_time=0%d00&nx=57&ny=121&dataType=JSON",hour);
