...
void getwheatherinfo(int year,int mon,int day,int hour){//날씨 정보를 획득합니다.
   ...
   if(mon<10){
    ...
    sprintf(httptext,"http://apis.data.go.kr/1360000/VilageFcstInfoService/getVilageFcst?serviceKey=MYkMEd1Kx5PWDad4K0CUzdminh1l8NocDD0sSSijoqivkQ%%2BdiwlZsSTq2pWRqO5KlmCFOlI5tA%%2B90TZhGDTaeA%%3D%%3D&numOfRows=60&base_date=%d%s%s&base_time=%s00&nx=57&ny=121&dataType=JSON",year,s_mon,s_day,s_hour);
    Serial.println(httptext);
    if (http.begin(client,httptext)) {  // HTTP
      ...
      if (httpCode > 0) {
        ...
        if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
         ...
         const size_t capacity=JSON_ARRAY_SIZE(70) + 2*JSON_OBJECT_SIZE(1) + 2*JSON_OBJECT_SIZE(2) + JSON_OBJECT_SIZE(5) + 70*JSON_OBJECT_SIZE(8)+7000;
...
//    case:0
//        display.drawBitmap(x,y,Sundayfont,32,15, WHITE);
//    break;
//    
//    case:1
//        display.drawBitmap(x,y,Mondayfont,32,15, WHITE);
//    break;
//    
//    case:2
//        display.drawBitmap(x,y,Tuesdayfont,32,15, WHITE);
//    break;
//    
//    case:3
//        display.drawBitmap(x,y,Wednesdayfont,32,15, WHITE);
//    break;
//    
//    case:4
//         display.drawBitmap(x,y,Tursdayfont,32,15, WHITE);
//    break;
//    
//    case:5
//            display.drawBitmap(x,y,Firdayfont,32,15, WHITE);
//    break;
//    
//    default:
//            display.drawBitmap(x,y,Saturdayfont,32,15, WHITE);
//    break;
//    
//    
//    }
