...
const char* ssid = "U+NetFB2F";
const char* password = "0137001065";
...
const unsigned char** skyimgary[9]={&skyimg0,&skyimg1,&skyimg2,&skyimg3,&skyimg4,&skyimg5,&skyimg6,&skyimg7,&skyimg8};
...
void getwheatherinfo(int year,int mon,int day,int hour){//날씨 정보를 획득합니다.
   ...
   if(mon<10){
    ...
    sprintf(httptext,"http://apis.data.go.kr/1360000/VilageFcstInfoService/getVilageFcst?serviceKey=MYkMEd1Kx5PWDad4K0CUzdminh1l8NocDD0sSSijoqivkQ%%2BdiwlZsSTq2pWRqO5KlmCFOlI5tA%%2B90TZhGDTaeA%%3D%%3D&numOfRows=80&base_date=%d%s%s&base_time=%s00&nx=60&ny=121&dataType=JSON",year,s_mon,s_day,s_hour);
...
void drawnowweather(){
 ...
 // display.drawBitmap(100,10,c,32,32, WHITE);
  ...
  display.display();
  Serial.printf("날씨 %d,%d,%d,%d,%d,%d,%d,%d\n",stsv[0].sky,stsv[1].sky,stsv[2].sky,stsv[3].sky,stsv[4].sky,stsv[5].sky,stsv[6].sky,stsv[7].sky);
  Serial.printf("기온 %d,%d,%d,%d,%d,%d,%d,%d\n",stsv[0].nt,stsv[1].nt,stsv[2].nt,stsv[3].nt,stsv[4].nt,stsv[5].nt,stsv[6].nt,stsv[7].nt);
  Serial.printf("날짜 %d,%d,%d,%d,%d,%d,%d,%d\n",stsv[0].fcstDate,stsv[1].fcstDate,stsv[2].fcstDate,stsv[3].fcstDate,stsv[4].fcstDate,stsv[5].fcstDate,stsv[6].fcstDate,stsv[7].fcstDate);
   Serial.printf("시간 %d,%d,%d,%d,%d,%d,%d,%d\n",stsv[0].fcstTime,stsv[1].fcstTime,stsv[2].fcstTime,stsv[3].fcstTime,stsv[4].fcstTime,stsv[5].fcstTime,stsv[6].fcstTime,stsv[7].fcstTime);
  delay(5000);
  }  
...
void printNdaytoHday(int x,int y){ //숫자 날짜를 한글로 출력하는 함수
  ...
  if(stsv[i].fcstDate%100==timeinfo->tm_mday){//오늘
